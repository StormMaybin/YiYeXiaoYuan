...
{
	public static String batchSend(String url, String un, String pw,
			String phone, String msg, String rd, String ex) throws Exception
	{
		...
		try
		{
			...
			method.setQueryString(new NameValuePair[] {
					...
					new NameValuePair("rd", rd), new NameValuePair("msg", msg),
