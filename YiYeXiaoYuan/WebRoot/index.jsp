...
<body>
	<div class="navigation1">
		<a href="login.html"><span class="glyphicon glyphicon-user"
			id="user1"></span> </a>
	</div>
	<div class="one-inner">
					...
					<li>
						<div class="one-information">
							<div class="information-time">
								<span>时间:</span> 
								<span class="time-date startDate"> <!-- 2016-10-21 -->${li.startDate}</span> 
								<span class="time-time startTime">
									<c:choose> 
							...
							<div class="information-where">
								<span>出发: 
									<span class="where-start startPos">${li.startPos }</span>
								</span> 
								<span class="where-end">到达:</span> 
								<span class="where-finish arrivePos">${li.arrivePos }</span>
							</div>
							<div class="information-people">
								<span class="glyphicon glyphicon-user people-applied"></span> <span
									...
									<p class="maxMember" style="display: inline;">${li.maxMember }</p>人，已有
									<p class="curtMember" style="display: inline;">${li.curtMember }</p>人</span>
							</div>
							<div class="information-remark">
								<span>备注:</span> <span class="remark-content message">${li.message }</span>
							</div>
	...
	<div class="one-dialog" id="dialog-success">
		<div class="dialog-inner">
			<span>报名成功。</span> <span>在我的行程查看拼车信息</span>
		</div>
	</div>
	<!--弹窗报名成功-->
